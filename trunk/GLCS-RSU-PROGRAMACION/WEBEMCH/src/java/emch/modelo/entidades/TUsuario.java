...
public class TUsuario  implements java.io.Serializable {
    ...
    public TUsuario(String nomUsu, TPerfil TPerfil, String pass, String estado) {
        this.nomUsu = nomUsu;
        this.TPerfil = TPerfil;
        this.pass = pass;
        this.estado = estado;
    }
    public TUsuario(String nomUsu, TPerfil TPerfil, String pass, String estado, Set<TTrabajador> TTrabajadors, Set<TCliente> TClientes) {
       this.nomUsu = nomUsu;
       this.TPerfil = TPerfil;
       this.pass = pass;
       this.estado = estado;
